...
if (format==0 && num_tracks~=1)
    disp(['Skipping file ', filename, ' because it has more than one track.']);
    midi = []; % Return empty midi structure, or handle as needed
    return; % Exit the function early for multi-track files
